                ...
                <div class="modal-body">
                    <form method="post" id="registerForm">
                        ...
                        <div class="my-3 mx-4">
                            ...
                            <div class="col-lg-8 my-3">
                                <input type="text" class="form-control border rounded-pill" placeholder="Programación II" id="subject">
                            </div>
                        </div>
                        <div class="my-3 mx-4">
                ...
                <div class="modal-body">
                    ...
                    <div class="my-3 mx-4">
                        ...
                        <div class="my-3 mx-4">
                            ...
                            <div class="col-lg-8 my-3">
                                <input type="text" class="form-control border rounded-pill" placeholder="Programación II" id="edit-subject">
                            </div>
                        </div>
                        <div class="my-3 mx-4">
